...
resource "google_secret_manager_secret_version" "customer_1_webhook_key_initial" {
  secret = google_secret_manager_secret.customer_1_webhook_key.id

  secret_data = "initial-webhook-secret-value"
}
